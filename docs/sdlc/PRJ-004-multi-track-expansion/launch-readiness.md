...
| 2 | **Run `--migrate-tracks` + spot-check** | **Engineer Lead** runs; **User** spot-checks | ✅ **Done 2026-07-07**: 201/201 migrated, 0 UNMIGRATED; tally AI-native 84 / Mid-large 92 / Robotics 6 / Fintech 12 / Space 3 / Defense 4; user spot-check accepted (R-05 closed). |
